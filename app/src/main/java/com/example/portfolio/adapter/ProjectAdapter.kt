...
class ProjectAdapter :
 ...
 override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
  return VhProject(AndroidItemBinding.inflate(LayoutInflater.from(parent.context), parent, false),
   onClick)
 }
...
private class VhProject(private val binding: AndroidItemBinding, private val onClick: OnClick<Type>?) :
